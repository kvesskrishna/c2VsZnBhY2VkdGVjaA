				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Day Trainings</li>
						</ul><!-- /.breadcrumb -->
					</div>
...
?>
	...
	<table id="ordersa" width="100%" cellspacing="0" class="display compact" width="70%">
        ...
        <tbody>
        <?php
        $sql_getdata="SELECT * FROM trainings WHERE training_time='Day'";
        ...
        while ($row_getdata=$res_getdata->fetch_assoc()) {
        	...
        	<tr>
               ...
               <td><?php if($udtraining_update==1) {?><a href="#edit<?php echo $row_getdata['training_id']?>" data-toggle="modal"><i class="fa fa-pencil-square-o"></i></a><?php } if($udtraining_delete==1) {?>
...
?>
    ...
    <p>
      <?php if($udtraining_delete==1){?>
        <form class="form-horizontal" method="post" action="exporttrainings.php">
