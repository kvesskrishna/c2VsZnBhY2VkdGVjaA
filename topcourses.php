...
<div class="container">
	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		...
		<?php
            $api_call= 'http://www.selfpacedtech.com/services/api/courses?transform=1&order=course_rating,desc&page=1,8';
 $curl = curl_init();
 ...
 ?>
            ...
            <div class="my-list">
              ...
              <span class="pull-right"> <?php echo $curr_symbol." ".currencyConverter('USD',$currency,$course->course_offer_price)?></span><br>
              <div class="offer">
              Rating: 
